...
if __name__ == '__main__':
    ...
    faceit.add_video('oliver', 'oliver_trumpcard.mp4', 'https://www.youtube.com/watch?v=6N3wAs5eIUU')
    faceit.add_video('oliver', 'oliver_taxreform.mp4', 'https://www.youtube.com/watch?v=fbyEDM9i0hw')
    faceit.add_video('oliver', 'oliver_zazu.mp4', 'https://www.youtube.com/watch?v=Db3onMGkLSo')
    faceit.add_video('oliver', 'oliver_pastor.mp4', 'https://www.youtube.com/watch?v=DgOgdGpWqzQ')
    ...
    faceit.add_video('fallon', 'fallon_bank.mp4', 'https://www.youtube.com/watch?v=yHCKZvrKWHE')
